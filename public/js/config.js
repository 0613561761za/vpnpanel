    ...
    $('#create-ssh').submit(function(event){
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                if(data.status == 'error'){
                  return swal('Whoops!', 'Daily limit reached!', 'error');
                }
            },
            error: function(data){
                $('#create-ssh :input').prop('disabled', false);
...
function deleteDomain(id,csrf)
{
    ...
    function(isConfirm){
      if (isConfirm) {
        $.ajax({
            type: 'POST',
            url: '/manage/admin/dns/domain/delete/' + id,
            data: '_token=' + csrf,
            success: function(data){
                console.log(data);
                swal("Deleted!", "Your DNS has been deleted!", "success");
...
$(document).ready(function(){
    $('#edit-ads').submit(function(e){
      e.preventDefault();
        var id = $('#ads-id').val();
        var data = $('#edit-ads').serialize();
        $.ajax({
          type: 'POST',
          url: '/manage/admin/ads/edit/' + id,
          data: data,
          beforeSend: function(){
            $('#edit-ads :input').prop('disabled', true);
            $('#btn-edit-ads').text('Please Wait......');
          },
          success: function(data){
            $('#edit-ads :input').prop('disabled', false);
            $('#edit-ads :input').val('');
            $('#btn-edit-ads').text('Save!');

            return swal('Success!', 'Changes successfully saved!', 'success');
          },
          error: function(data){
            $('#edit-ads :input').prop('disabled', false);
            $('#edit-ads :input').val('');
...
$(document).ready(function(){
    $('#ssh-server-edit').submit(function(e){
        e.preventDefault();
        var id = $('#ssh-id').val();
        var data = $('#ssh-server-edit').serialize();
        $.ajax({
          type: 'POST',
          url: '/manage/admin/server/ssh/edit/' + id,
          data: data,
          beforeSend: function(){
            $('#ssh-server-edit :input').prop('disabled', true);
            $('#btn-edit-ssh-server').text('Please Wait......');
          },
          success: function(data){
            $('#ssh-server-edit :input').prop('disabled', false);
            $('#ssh-server-edit :input').val('');
            $('#btn-edit-ssh-server').text('Please Wait......');

            return swal('Success!', 'Your change has been applied!', 'success');
          },
          error: function(data){
            $('#ssh-server-edit :input').prop('disabled', false);
            $('#ssh-server-edit :input').val('');
            ...
            return swal('Whoops!', 'Error detected!' , 'error');
          }
        });
    });
});
$(document).ready(function(){
    $('#group-edit').submit(function(e){
        e.preventDefault();
        var id = $('#group-id').val();
        var data = $('#group-edit').serialize();
        $.ajax({
            type: 'POST',
            url: '/manage/admin/group/edit/' + id,
            data: data,
            beforeSend: function(){
              $('#group-edit :input').prop('disabled', true);
              $('#btn-edit-group').text('Please Wait.....');
            },
            success: function(data){
              $('#group-edit :input').prop('disabled', false);
              $('#group-edit :input').val('');
              $('#btn-edit-group').text('Save!');

              return swal('Success!', 'Your changes successfully saved!', 'success');
            },
            error: function(data){
              $('#group-edit :input').prop('disabled', false);
              $('#group-edit :input').val('');
...
$(document).ready(function(){
    $('#squid-edit').submit(function(e){
        e.preventDefault();
        var id = $('#squid-id').val();
        var data = $('#squid-edit').serialize();
    });
});
$(document).ready(function(){
    $('#vpn-server-edit').submit(function(e){
        e.preventDefault();
        var id = $('#vpn-id').val();
        var data = $('#vpn-server-edit').serialize();
        $.ajax({
            type: 'POST',
            url: '/manage/admin/server/vpn/edit/' + id,
            data: data,
            beforeSend: function(){
                $('#vpn-server-edit :input').prop('disabled', true);
                $('#btn-edit-vpn-server').text('Please Wait......');
            },
            success: function(data){
                $('#vpn-server-edit :input').prop('disabled', false);
                $('#vpn-server-edit :input').val('');
                $('#btn-edit-vpn-server').text('Save!');
